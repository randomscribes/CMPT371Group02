 ...
 * @author adammravnik
 */
public class addGoalServTest {
    
    private Mockery mockContext = new Mockery(); 
    
    public addGoalServTest() {
    }
    ...
    /**
     * Test of processRequest method, of class addGoalServ.
     */
    @Test
    public void testProcessRequest() throws Exception {
        ...
        System.out.println("Jmock testing of addGoalServ servlet successful");
    }
