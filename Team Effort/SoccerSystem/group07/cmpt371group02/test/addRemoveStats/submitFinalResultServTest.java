 ...
 * @author adammravnik
 */
public class submitFinalResultServTest {
    
    private Mockery mockContext = new Mockery();
    
    public submitFinalResultServTest() {
    }
    ...
    /**
     * Test of processRequest method, of class submitFinalResultServ.
     */
    @Test
    public void testProcessRequest() throws Exception {
        ...
        final displayFinalScoreServ instance = new displayFinalScoreServ();
